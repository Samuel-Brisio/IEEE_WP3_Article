...
#sudo conntrack -D -d 192.168.00.1/24 -p tcp
#echo "Flush -d 192.168.00.1/24"
#sudo conntrack -D -d 192.168.10.1/24 -p tcp
#echo "Flush -d 192.168.10.1/24"
#sudo conntrack -D -d 192.168.20.1/24 -p tcp
#echo "Flush -d 192.168.20.1/24"
#sudo conntrack -D -d 192.168.30.1/24 -p tcp
#echo "Flush -d 192.168.30.1/24"
...
do
	...
	# Start the Emulation
	#####################
	/wp3-experiment/Scripts/fase_02/rand_start.sh $RANDOM
