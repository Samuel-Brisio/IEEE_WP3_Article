...
do
    ...
    do  
        ...
        echo "EXPERIMENT summary_udp_delay.py"
        ...
        echo "FIRST ATTACK summary_udp_delay.py " ${first_attack_time[2*(i-1)]} ${first_attack_time[2*(i-1)+1]}
        ...
        echo "SECOND ATTACK summary_udp_delay.py" ${second_attack_time[2*(i-1)]} ${second_attack_time[2*(i-1)+1]}
